...
public class RegistroDeProductoUpdate {
    public static void main(String[] args) {
        ...
        /*
        la finalidad del metodo merged es traer registros deseados con un estado managed
        pero en una ubicacion diferente en memoria, por lo que tenemos que reasignar
        la variable que se encuentra como detached
         */
